...
import App from "../App";
import S1ReservationList2 from "./S1ReservationList2";

const S1Reservation2 = () => {
          ...
          <div className="RInner-container">
            <div className="reservation-container">
              <div className="reservation-form-container">
                <h2 className="reservation-form-heading">매장 1 Table 2 예약하기</h2>
